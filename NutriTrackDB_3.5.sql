...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 05. 10:45
...
INSERT INTO `users` (`user_id`, `username`, `password_hash`, `email`, `height_cm`, `weight_kg`, `created_at`, `privilege`, `email_verification_token`, `verification_token_expiry`, `is_active`) VALUES
(1, 'testuser1', '$2a$11$dummyhashuser1', 'testuser1@email.com', 178, 92.00, '2026-01-14 07:42:57', NULL, NULL, NULL, 0),
(2, 'testuser2', '$2a$11$dummyhashuser2', 'testuser2@email.com', 165, 75.00, '2026-01-14 07:42:57', NULL, NULL, NULL, 0);

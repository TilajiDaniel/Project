...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Ápr 06. 18:24
...
(5, 3, '2026-04-06', 'Lunch', '2026-04-06 13:19:09'),
(6, 3, '2026-04-06', 'Breakfast', '2026-04-06 13:19:15'),
(7, 3, '2026-04-06', 'Lunch', '2026-04-06 13:19:21');
...
CREATE TABLE `users` (
  ...
  `email_verification_token` varchar(600) DEFAULT NULL,
  `verification_token_expiry` datetime DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT 0,
  `setup_completion` tinyint(4) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`user_id`, `username`, `password_hash`, `email`, `height_cm`, `weight_kg`, `created_at`, `privilege`, `email_verification_token`, `verification_token_expiry`, `is_active`, `setup_completion`) VALUES
(3, 'Teszter', '$2a$12$XZFZG2aeEJH.jvxArYKooOxQfi9rfBzQSXxWrfbSqopXdlcwaxdWK', 'tilajid@kkszki.hu', 202, 106.00, '2026-04-06 13:16:01', 2, NULL, NULL, 0, 3),
(4, 'AdminUser', '$2a$12$u5rr1njGLx7ikZOkSGZqh.sfYnFLnyFryy0oKx74DdE1TmcM6SSKC', 'acwecd0@gmail.com', NULL, NULL, '2026-04-06 13:17:32', 3, NULL, NULL, 0, 0);
...
(3, 2968, 3710, 'UTC', '2026-04-06 13:19:01');
...
(5, 3, '2026-04-06', 500, '2026-04-06 11:19:30'),
(6, 3, '2026-04-06', 500, '2026-04-06 11:19:30'),
(7, 3, '2026-04-06', 500, '2026-04-06 11:19:31');
...
(3, 3, 97.00, '2026-04-06', '0001-01-01', '2026-04-06 13:18:44');
...
(5, 3, 105.00, '2026-04-06', '2026-04-06 13:19:29');
...
ALTER TABLE `meals`
  ...
  ADD KEY `unique_meal_per_day` (`user_id`,`meal_date`,`meal_type`) USING BTREE;
...
--
ALTER TABLE `weight_log`
  MODIFY `weight_entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_users_privilege_final` FOREIGN KEY (`privilege`) REFERENCES `privilege` (`Id`);

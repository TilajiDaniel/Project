...
//        public WaterIntakeController(NutritrackAPI.Models.NutritrackContext context)
//        {
//            _context = context;
//        }

//        [Authorize(Roles = "10, 2")]
//        [HttpGet("GetWaterIntakes")]
//        public async Task<IActionResult> GetAllWaterIntakes()
//        {

//            try
//            {
//                List<WaterIntake> WaterIntakes = await _context.WaterIntakes.ToListAsync();
...
//        [HttpGet("WaterIntakeById/{Id}")]
//        public async Task<IActionResult> GetWaterIntakeById(int Id)
//        {

//            try
//            {
//                var waterIntake = await _context.WaterIntakes.FirstOrDefaultAsync(w => w.EntryId == Id);
//                if (waterIntake is WaterIntake)
//                {
//                    return Ok(waterIntake);
//                }
//                else
//                {
//                    return BadRequest(new WaterIntake()
//                    {
//                        EntryId = -1,
//                        Name = $"Hiba történt: Nincs ilyen azonosítójú vízfogyasztás",
